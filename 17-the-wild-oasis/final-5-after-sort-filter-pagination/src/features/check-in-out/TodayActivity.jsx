  ...
  return (
    <StyledToday>
      <Row type='horizontal'>
        ...
        {/* Through the 'as' props, we make the button Polymorphic! Built-in into styled _components. The polymorphic component pattern comes in handy when we need flexibility on the rendered HTML element. */}
